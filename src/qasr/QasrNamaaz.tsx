...
export const QasrNamaaz: React.FC<{ googleMapsApiKey: string }> = React.memo(({ googleMapsApiKey }) => {
    ...
    const toggleCard = React.useCallback((idx: number) => setOpenCards(prev => ({ ...prev, [idx]: !prev[idx] })), []);
                ...
                <div className="rc-body">
                            ...
                            <>
                                ...
                                {r.rnum ? (
                                    <div className="rule-note">
                                        <span className="rule-n">{r.rnum}</span> <strong>Rule {r.rnum} Applied:</strong>{" "}
                                        {/* rtxt contains only <strong> tags generated by our own engine */}
                        ...
                        {r.di ? (
                            <>
                                ...
                                <div className="dist-note">
                                    Compare Google Maps driving distance to the app value &mdash; should be within ~0.5
                                    miles.
                                </div>
                            </>
                        ) : (
                    ...
                    <div className={"tab-pane" + (activeTab === "navigate" ? " on" : "")}>
                        <div className="nav-notice">
                            This ruling applies <strong>only to this specific route</strong>. When opening Google Maps,
                            select the route that matches the details below.
                        </div>
